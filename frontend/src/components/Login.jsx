...
const Login = () => {
  ...
  return (
    <div className="bg-white h-[100vh] w-full flex justify-between items-center">
      <img
        className="w-[65%] h-[70vh] object-cover"
        alt=""        
        src="https://i.ytimg.com/vi/XUPF_FDDCMk/maxresdefault.jpg"
      />
      <div className="w-[35%] flex justify-center items-start flex-col pl-8">
